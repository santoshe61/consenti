...
export const metadata: Metadata = {
  ...
  description:
    'UK GDPR compliance guide for Consenti — the retained EU GDPR under UK law, supplemented by the Data Protection Act 2018.',
  alternates: { canonical: '/docs/compliance/uk-gdpr' },
  openGraph: {
    title: 'UK GDPR Compliance Guide',
    description:
      'UK GDPR compliance guide for Consenti — the retained EU GDPR under UK law, supplemented by the Data Protection Act 2018.',
    url: 'https://consenti.dev/docs/compliance/uk-gdpr',
...
export default function UKGDPRPage() {
  return (
    <div className="prose max-w-none">
      ...
      <p>
        After Brexit, the United Kingdom retained the EU GDPR in domestic law as the{' '}
      ...
      <Callout type="info">
        If you operate in both the EU and UK you can set{' '}
        <code>regulations: ['gdpr', 'uk-gdpr']</code> in your profile. Consenti will apply the
        stricter of the two for any given visitor.
      </Callout>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>Pre-ticked boxes</td>
            <td>Not permitted (UK GDPR Art. 4(11))</td>
          </tr>
          <tr>
            <td>Bundled consent</td>
            <td>Not permitted — each purpose must be separately consented</td>
          </tr>
          <tr>
            <td>Withdrawal</td>
          ...
          <tr>
            <td>Records</td>
            <td>Controllers must demonstrate consent was obtained (accountability)</td>
          </tr>
          <tr>
            <td>Age</td>
            <td>
              Under-13 requires parental consent (lower than EU's 16, unless Member State lowered)
            </td>
          </tr>
          <tr>
            <td>GPC</td>
            <td>Not yet a recognised signal under UK GDPR; ICO guidance pending</td>
          </tr>
          <tr>
            <td>Enforcer</td>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>Age threshold</td>
            <td>16 (Member States may lower to 13)</td>
            <td>13</td>
          </tr>
          <tr>
            <td>Enforcer</td>
          ...
          <tr>
            <td>Adequacy</td>
            <td>EU decides on third-country adequacy</td>
            <td>UK decides independently</td>
          </tr>
          <tr>
            <td>GDPR article numbering</td>
            <td>Original</td>
            <td>Identical — UK GDPR mirrors article numbers</td>
          </tr>
        </tbody>
      </table>
  ...
  "gpc": {
    "mode": "honour"
      ...
      />
      <p>
        When both are active, Consenti applies EU GDPR opt-in by default (the stricter model) for
        all visitors. GPC honour is recommended for EU GDPR visitors even though it is not yet
        mandated under UK GDPR.
      </p>
